...
/**
 * The mod_forumplusone post updated event.
 *
...
/**
 * The mod_forumplusone post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_forumplusone');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumplusone', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
