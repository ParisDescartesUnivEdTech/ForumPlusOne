...
/**
 * The mod_forumimproved post updated event.
 *
...
/**
 * The mod_forumimproved post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_forumimproved');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumimproved', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
