...
/**
 * The mod_forumimproved post created event.
 *
...
/**
 * The mod_forumimproved post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_forumimproved');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumimproved', 'add post', $logurl, $this->other['forumid'], $this->contextinstanceid);
    }
