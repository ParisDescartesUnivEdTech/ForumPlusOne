...
/**
 * The mod_forumplusone discussion moved event.
 *
...
/**
 * The mod_forumplusone discussion moved event class.
 *
...
class discussion_moved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionmoved', 'mod_forumplusone');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumplusone', 'move discussion', 'discuss.php?d=' . $this->objectid,
