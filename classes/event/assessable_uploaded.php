...
/**
 * The mod_forumplusone assessable uploaded event.
 *
...
/**
 * The mod_forumplusone assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename   = 'forumplusone';
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_forumplusone');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/forumplusone/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }
