...
/**
 * The mod_forumplusone discussion viewed event.
 *
...
/**
 * The mod_forumplusone discussion viewed event class.
 *
 * @package    mod_forumplusone
 * @since      Moodle 2.7
 * @copyright  2014 Dan Poltawski <dan@moodle.com>
...
class discussion_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionviewed', 'mod_forumplusone');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumplusone', 'view discussion', 'discuss.php?d=' . $this->objectid,
