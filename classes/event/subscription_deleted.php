...
/**
 * The mod_forumimproved subscription deleted event.
 *
...
/**
 * The mod_forumimproved subscription deleted event class.
 *
...
class subscription_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubscriptiondeleted', 'mod_forumimproved');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumimproved', 'unsubscribe', 'view.php?f=' . $this->other['forumid'],
