...
/**
 * The mod_forumplusone subscription deleted event.
 *
...
/**
 * The mod_forumplusone subscription deleted event class.
 *
...
class subscription_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubscriptiondeleted', 'mod_forumplusone');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumplusone', 'unsubscribe', 'view.php?f=' . $this->other['forumid'],
