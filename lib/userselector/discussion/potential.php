...
class forumplusone_userselector_discussion_potential extends forumplusone_userselector_discussion_abstract {
    /**
    ...
    public function get_filepath() {
        return '/mod/forumplusone/lib/userselector/discussion/potential.php';
    }

    public function find_users($search) {
        return array(
            get_string("potentialsubscribers", 'forumplusone') =>
